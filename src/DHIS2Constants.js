...
export const ATTR_PHONE = "ihz1qXLws99";
//export const ATTR_NO_OF_CONTACTS = "DDleOZ1LGAq";

export const REL_CASE_TO_CASE = "u75AxgQVqM6";
export const REL_CASE_TO_SUSPECT = "v4gG3CVczjb";
